...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/05/15 18:15:28 by ilymegy           #+#    #+#             */
/*   Updated: 2024/05/15 18:15:29 by ilymegy          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	perform_dda(t_data *data, t_ray *ray)
{
	...
	while (hit == 0)
	{
		...
		if (ray->map_y < 0.25 || ray->map_x < 0.25
			...
			break ;
		else if (data->map.map[ray->map_y][ray->map_x] > '0')
			hit = 1;
	}
}
...
int	raycasting(t_player *player, t_data *data)
{
	...
	while (x < data->win_width)
	{
		...
		update_texture_pixels(data, &data->txt, &ray, x++);
	}
	return (0);
}
